  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以向任务中导入数据</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/addSaleData?&token='+token+'&taskid=3999&salenum=202002270304152246'}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskAPI_6.json')
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
               this.$store.state.baseURL+'open/addSaleData?&token='+this.token+'&taskid=3999&salenum=202002270304152246'
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
