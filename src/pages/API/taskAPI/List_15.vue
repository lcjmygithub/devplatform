  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以新增任务</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/saveSaletask?token='+token}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskAPI_8.json')
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
               this.$store.state.baseURL+'open/saveSaletask?token='+this.token
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
