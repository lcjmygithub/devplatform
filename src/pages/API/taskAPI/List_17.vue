  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以查询数据批次</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/getZtSaleDataoverviewList?token='+token+'&pageBean.pageNo=1&pageBean.pageSize=10'}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskAPI_10.json')
            ...
            children:[
               {
               ...
               },
                {
                  ...
                  return_required: '否',
                  return_types:'String',
                  return_introstactor:'导入人',
               },
                 {
                  return_refsName: 'number',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'数量',
               },
                 {
                  return_refsName: 'salenum',
                  return_required: '否',
                  return_types:'String',
                  return_introstactor:'批次号'
                 },
                  {
                  return_refsName: 'showname',
                  return_required: '否',
                  return_types:'String',
                  return_introstactor:'批次名称',
               },
               {
                  return_refsName: 'state',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'状态',
               },
               {
                  return_refsName: 'time',
                  return_required: '否',
                  return_types:'String',
                  return_introstactor:'导入时间',
               }
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
             this.$store.state.baseURL+'open/getZtSaleDataoverviewList?token='+this.token+'&pageBean.pageNo=1&pageBean.pageSize=10'
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
