  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以查询任务列表</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/getZtCmpSaletaskList?pageBean.pageNo=1&pageBean.pageSize=10&token='+token}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskAPI_3.json')
         ...
         tableData1:[
          ...
          return_introstactor:'响应信息',
            children:[
                ...
                return_required: '否',
                return_types:'Array',
                return_introstactor:'任务列表',
                 children:[
                     {
                        return_refsName: 'callrate',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'接通率',
                     },
                       {
                        return_refsName: 'harrynum',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'防骚扰数',
                     },
                       {
                        return_refsName: 'hascall',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'已呼总数',
                     },

                      {
                        ...
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'创建人',
                     },
                       {
                        return_refsName: ' taskid',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'任务Id',
                     },
                       {
                     ...
                     },
                     {
                        ...
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'任务总数',
                     },
                     {
                        return_refsName: 'yesnum',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'接通数',
                     },
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
               this.$store.state.baseURL+'open/getZtCmpSaletaskList?pageBean.pageNo=1&pageBean.pageSize=10&token='+this.token
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
