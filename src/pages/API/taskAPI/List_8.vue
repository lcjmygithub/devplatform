  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以查询任务中已完成的电话</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/getSaleDataList?pageBean.pageNo=1&pageBean.pageSize=10&ztSaleData.taskid=3999&ztSaleData.salenum=202002250409372483&token='+token}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskApI_1.json')
...
export default {
        ...
        {title:'正确示例',active:false}
          ...
          tableData:[
            ...
            introstactor:'token令牌',
             ...
             {
            refsName: 'pageBean.pageNo',
            required: '是',
            types:'Number',
            introstactor:'页码数',
            },
             {
            refsName: 'pageBean.pageSize',
            required: '是',
            types:'Number',
            introstactor:'页码大小',
            },
            {
            refsName: 'ztSaleData.taskid',
            required: '否',
            types:'Number',
            introstactor:'任务id',
            },
               {
            refsName: 'ztSaleData.salenum',
            required: '否',
            types:'String',
            introstactor:'批次',
            },
         ...
         tableData1:[
          ...
          return_introstactor:'响应信息',
            children:[
                ...
                return_required: '否',
                return_types:'Array',
                return_introstactor:'通话列表',
                 children:[
                     {
                        return_refsName: 'callresult',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'通话结果',
                     },
                       {
                        return_refsName: 'calltime',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'通话时长',
                     },
                       {
                        return_refsName: 'calltype',
                        return_required: '否',
                        return_types:'Array',
                        return_introstactor:'任务类型',
                     },

                      {
                        return_refsName: 'closeresult',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'拨打结果',
                     },
                       {
                       ...
                       {
                        return_refsName: 'iclevelid',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'意向id',
                     },
                     {
                        return_refsName: 'iclevelname',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'意向名称',
                     },
                     {
                        return_refsName: 'isblack',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'是否黑名单',
                     },
                      {
                        return_refsName: ' isread',
                        return_required: '否',
                        return_types:'',
                        return_introstactor:'是否已读',
                     },
                     {
                       ...
                       {
                        return_refsName: 'remark',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'备注',
                     },
                     {
                        return_refsName: 'saleid',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'数据Id',
                     },
                      {
                        return_refsName: 'salenum',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'批次',
                     },
                     {
                        return_refsName: ' taskname',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'任务名称',
                     },
                      {
                        return_refsName: 'tempcustemail',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'客户邮箱',
                     },
                     {
                        return_refsName: 'tempcustomername',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'客户名称',
                     },
                        {
                        return_refsName: 'templevel',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                      {
                        return_refsName: 'tempmobilephone',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'',
                     },
                     {
                        return_refsName: 'temporarycustomerid',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                      {
                        return_refsName: 'tmcustid',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                     {
                        return_refsName: ' voxfile',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'', 
                     },
                 ...
                 {
                return_refsName: 'pageNo',
                return_required: '否',
                return_types:'Number',
                return_introstactor:'页码数',
                },
                 {
                return_refsName: 'pageSize',
                return_required: '否',
                return_types:'Number',
                return_introstactor:'页码大小',
                },
                 {
                return_refsName: 'totalCount',
                return_required: '否',
                return_types:'Number',
                return_introstactor:'总数',
                },
                  {
                return_refsName: ' totalPages',
                return_required: '否',
                return_types:'Number',
  ...
  created() {
     this.token = window.sessionStorage.getItem('token')?window.sessionStorage.getItem('token'):''
  },
  methods: {
    //关闭抽屉
    handleClose(){
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
               this.$store.state.baseURL+'open/getSaleDataList?pageBean.pageNo=1&pageBean.pageSize=10&ztSaleData.taskid=3999&ztSaleData.salenum=202002250409372483&token='+this.token
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
