  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以查询任务详情</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/getSaleTaskOverView?pageBean.pageNo=1&pageBean.pageSize=10&taskid=3999&token='+token}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskAPI_2.json')
         ...
         tableData1:[
          ...
          return_introstactor:'响应信息',
            children:[
                ...
                return_required: '否',
                return_types:'Array',
                return_introstactor:'任务信息列表',
                 children:[
                     {
                        return_refsName: 'call_num',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                       {
                        return_refsName: 'cmpid',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'公司Id',
                     },
                       {
                        return_refsName: 'effectivetime',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },

                      {
                       ...
                       {
                        return_refsName: 'leavenum',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                       {
                        return_refsName: 'number',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                     ...
                     {
                        return_refsName: 'showname',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'',
                     },
                      {
                        return_refsName: 'state',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                     {
                        return_refsName: 'succ_num',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                       {
                        return_refsName: 'succ_rate',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'成功率',
                     },
                     {
                        return_refsName: 'time',
                        return_required: '否',
                        return_types:'Number',
                        return_introstactor:'',
                     },
                      {
                        return_refsName: 'userid',
                        return_required: '否',
                        return_types:'String',
                        return_introstactor:'',
                     },
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
            this.$store.state.baseURL+'open/getSaleTaskOverView?pageBean.pageNo=1&pageBean.pageSize=10&taskid=3999&token='+this.token
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
