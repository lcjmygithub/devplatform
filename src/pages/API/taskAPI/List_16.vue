  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以导入文件</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{this.$store.state.baseURL+'open/manyAddSaleData?token='+token+'showname=111'}}
...
<script>
const dataJson = require('../../../../json/taskAPI/taskAPI_9.json')
        ...
        {title:'正确示例',active:false}
         ...
         tableData1:[
      ...
      
           {
            ...
            children:[
               {
                  return_refsName: 'content[0]',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'导入数据失败的条数',
               },
                {
                  return_refsName: 'content[1]',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'导入数据成功的条数',
               },
                 {
                  return_refsName: 'content[2]',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'导入数据重复的条数',
               },
                 {
                  return_refsName: 'content[3]',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'导入数据黑名单的条数'
                 },
                  {
                  return_refsName: 'content[4]',
                  return_required: '否',
                  return_types:'Number',
                  return_introstactor:'导入数据靓号的条数',
               }
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       doCopy(e) {
             this.$copyText(
               this.$store.state.baseURL+'open/manyAddSaleData?token='+this.token+'showname=111'
             ).then((e) => {
               // success
                 this.$message({
                showClose: false,
