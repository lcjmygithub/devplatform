  ...
  <div>
    <div class="api-details">
      <div class="title_h1">
        ...
        <div class="info">通过接口可以获取指定公司的所有线路的列表</div>
      </div>
      <div class="get-url">
        <div class="basic">
          <h1 style="font-size: 20px;">请求地址</h1>
          <div class="info">
             {{$store.state.baseURL+'open/getCmpOutNumber?token='+token}}
...
<script>
const dataJson = require('../../../../json/companyAPI/companyAPI_1.json')
export default {
  data() {
    return {
        token:'',
       ...
       requesList:[
        ...
        {title:'正确示例',active:false}
         ...
         tableData1:[
          ...
          return_required: '否',
          return_types:'Aarry',
          return_introstactor:'外呼线路列表信息',
          //子项
           children: [
             {
                return_refsName: 'phone',
                return_required: '否',
                return_types:'String',
                return_introstactor:'号码'
             },
              {
                return_refsName: 'phoneId',
                return_required: '否',
                return_types:'String',
                return_introstactor:'线路Id',
             },
  ...
  methods: {
    ...
    //在线调式
      ...
      resetForm(formName) {
       ...
       //复制 文本
       doCopy(e) {
             this.$copyText(this.$store.state.baseURL+'open/getCmpOutNumber?token='+this.token).then((e) => {
               // success
                 this.$message({
                showClose: false,
                center:true,
